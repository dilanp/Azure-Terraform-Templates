...
resource "azurerm_subnet_network_security_group_association" "app_subnet_nsg_association" {
  depends_on                = [azurerm_network_security_rule.app_nsg_rule_inbound] # Avert azurerm provider known bug with nsg rules.
...
locals {
  app_inbound_ports_map = {
    "100" : "80" # Use ":" instead of "=" if key starts with a number!
    "110" : "443"
    "120" : "8080"
    "130" : "22"
  }
